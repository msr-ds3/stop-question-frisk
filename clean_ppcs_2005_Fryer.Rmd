...
ppcs_2005_F <- ppcs_2005_F %>%
  mutate_at(.funs = list( ~ ifelse(is.na(.) & ppcs_2005_F$any_force == 1, 0, .)), .vars = colnames(ppcs_2005_tmp)) %>%
  mutate_at(.funs = list( ~ ifelse(is.na(.) & (V12 == 'No' | V14 == 'No'), 0, .)), .vars = colnames(ppcs_2005_tmp))
...
save(ppcs_2005_F, file = "clean_data/ppcs_2005_F.Rdata")
```
