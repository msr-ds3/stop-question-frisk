...
ppcs2002 <- sas_ascii_reader('ppcs_2002.txt','ppcs_2002_setup.sas')
View(ppcs2002)

# filter out people who haven't been in contact with the police
# ppcs2002 <- ppcs2002 %>%
...
# alt_outcomes
# search of driver or vehicle
# search occured before arrest
# other contact - personal search
ppcs2002 <- ppcs2002 %>%
...
save(ppcs2002_polished, file = 'ppcs_2002.Rdata')
