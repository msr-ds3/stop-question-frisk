...
mylogit_prec <- glm(any_force_used ~ race + sex + I(age^2) + inout + daytime + ac_incid + ac_time +
                 offunif + typeofid + othpers + cs_bulge + cs_cloth + cs_casng + cs_lkout +
                 cs_descr + cs_drgtr + cs_furtv + cs_vcrim +
                 cs_objcs + cs_other + wepnfnd + addrpct + year,
               data = log_panel_data,
...
save(mylogit_prec, file = "C:/Users/Etta Rapp/Documents/GitHub/stop-question-frisk/raw_data/log_model.RData")
